...
| 8001 | Security Engine | http://localhost:8001 | Interceptors — `/intercept/prompt`, `/intercept/tool`, `/intercept/output`, `/intercept/network`, `/intercept/filesystem`, `/intercept/browser`, `/analyze/hallucination` |
...
| M4 — Full Security Coverage | 14–17 | **In progress** (Phases 14–15 complete) |
